		...
		<header className="border-b border-zinc-200 dark:border-zinc-800 shadow-sm py-5">
			...
			<Container className="hidden lg:flex items-center">
				<div className="flex-1">
					<nav className="flex">
						<Link href="/">
							<a className="text-2xl italic font-extrabold text-rose-600 dark:text-rose-500 hover:text-rose-500 dark:hover:text-rose-600 transition-colors duration-150">
								sharep
							</a>
						</Link>
									...
									<Link href={link}>
										<a
											className={clsx(
												...
												'flex items-center gap-2 hover:text-black dark:hover:text-white transition-colors duration-150',
											)}
										>
