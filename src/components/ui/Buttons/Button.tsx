...
export const BUTTON_COLORS = {
	primary: {
		...
		outlined:
			'bg-transparent text-rose-600 dark:text-rose-500 hover:text-rose-700 dark:hover:text-rose-400 border border-rose-400 dark:border-rose-400 hover:border-rose-500 dark:hover:border-rose-300 leading-5 font-medium focus:outline-none rounded-md shadow-md',
	},
	unstyled: {
		base: '',
		outlined: '',
