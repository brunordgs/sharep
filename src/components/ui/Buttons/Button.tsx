...
export const BUTTON_COLORS = {
	primary: {
		base: 'bg-rose-600 text-zinc-100 hover:text-white border border-rose-500 hover:border-rose-400 leading-5 font-medium focus:outline-none rounded-md shadow-md',
		outlined:
			'bg-transparent text-rose-600 hover:text-rose-700 border border-rose-400 hover:border-rose-500 leading-5 font-medium focus:outline-none rounded-md shadow-md',
	},
	unstyled: {
		base: '',
		outlined: '',
