			...
			<div className="bg-gradient-to-r from-pink-600 to-rose-500 rounded-lg p-4 text-zinc-100 dark:text-zinc-200">
				<header className="flex items-center justify-between">
					...
					<button
						...
						className="bg-zinc-100/40 hover:bg-zinc-100/20 dark:bg-zinc-800/20 dark:hover:bg-zinc-800/40 hover:text-white size-6 rounded-full flex items-center justify-center transition-colors"
					>
